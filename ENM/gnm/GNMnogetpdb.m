...
%prot=getpdb(fname1); %getpdb Error using getpdb (line 119)
%Unknown problem accessing entry 2SRC in the PDB database.
websave(fname1, sprintf('https://files.rcsb.org/download/%s',fname1));
prot=pdbread(fname1);
end
