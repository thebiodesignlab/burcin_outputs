#!/bin/bash
#SBATCH -p gpu
#SBATCH --job-name=wo4RNP
#SBATCH --mem=32g
#SBATCH --gres=gpu:1
#SBATCH -c 3
#SBATCH --output=debug4.out
#SBATCH --time=4-0:0:0
...
python $pmpnn/helper_scripts/make_pos_neg_tied_positions_dict.py --input_path=$path_for_parsed_chains --output_path=$path_for_tied_positions --homooligomer 1 --pos_neg_chain_list="D E I" --pos_neg_chain_betas "1.0 1.0 1.0"
